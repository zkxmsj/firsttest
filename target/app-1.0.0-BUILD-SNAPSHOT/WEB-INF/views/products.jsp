...
function getCategorytList(){
    	$.ajax({
    		...
    		success:function(data){
    			...
    			str+='<button type="button" class="btn btn-light category" value="all">전체보기'+'('+count+')</button>';
    			str+='</div>';
    			...
    			$(data).each(function(){
    				...
    				str+='<div class="col-md-2">'; 				
    				str+='<button type="button" class="btn btn-light category" value="'+this.category+'">'+this.category+'('+this.count+')</button>';
    				str+='</div>';
	  			});
    			$("#category").html(str);
    		},
